...
<body>
	<?php 
		...
		if (isset($_POST['submit'])) {
			# code...
			if (empty($_POST["name"])) {
				$err_name = "chua nhap ten";
				$err = 1;
			}
			if (empty($_POST["email"])) {
				$err_email = "chua nhap email";
				$err = 1;
			}
			if (empty($_POST["password"])) {
				$err_pass = "chua nhap pas";
				$err = 1;
			}
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form enctype="multipart/form-data" method="post">
							...
							<?php echo $err_pass ?>
							Avatar<input name="avatar" type="file" placeholder=""/>
